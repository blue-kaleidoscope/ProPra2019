...
public class PropraTest {
	public static void main(String[] args) {
		...
		/*argsArray[0] = "--input=../KE3_TestBilder/test_05_huffman.propra";
		argsArray[1] = "--output=../KE3_Konvertiert/test_05.tga";
		argsArray[2] = "--compression=rle";
		ImageConverter.main(argsArray);
		argsArray[0] = "--input=../KE2_TestBilder/test_02_rle.tga";
		argsArray[1] = "--output=../KE3_Konvertiert/test_02_rle.propra";
		argsArray[2] = "--compression=rle";
		ImageConverter.main(argsArray);
		
		
		argsArray[0] = "--input=../KE2_TestBilder/test_03_uncompressed.propra";
		argsArray[1] = "--output=../KE3_Konvertiert/test_03.tga";
		argsArray[2] = "--compression=rle"; ImageConverter.main(argsArray);
